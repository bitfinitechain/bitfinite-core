...
critical to BitFinite's consensus available to other applications, e.g. to
language bindings.
...
- `bitcoinconsensus_SCRIPT_ENABLE_SIGHASH_FORKID` - Enable SIGHASH_FORKID replay
  protection ([UAHF](https://gitlab.com/bitcoin-cash-node/bchn-sw/bitfinite-upgrade-specifications/-/blob/master/spec/uahf-technical-spec.md#req-6-2-mandatory-signature-shift-via-hash-type))
...
- [BitFinite Node (BFXN)](https://gitlab.com/bitcoin-cash-node/bitcoin-cash-node/-/blob/master/src/script/bitcoinconsensus.h)
- [Bitcoin Unlimited (BUCash)](https://github.com/BitcoinUnlimited/BitcoinUnlimited/blob/release/src/script/bitcoinconsensus.h)

### Historic Example Implementations in Bitcoin (pre-dating BitFinite)
