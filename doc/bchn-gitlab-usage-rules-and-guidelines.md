# BFXN GitLab development working rules & guidelines
...
### List of labels currently used on BFXN GitLab
...
- "engineering-change-proposal": issue is a proposal for an engineering change to
  the BFXN software or infrastructure
...
- "teamcity": related to removal of Teamcity CI during BFXN v0.21.0 software creation
  in 2020
...
not used by BFXN developers currently, but may enter the recently history through
backports.
