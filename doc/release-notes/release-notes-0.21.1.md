Release Notes for BitFinite Node version 0.21.1
==================================================

BitFinite Node version 0.21.1 is now available from:
...
This is a second, minor release of BitFinite Node before the May 2020
...
BitFinite Node is a drop-in replacement for Bitcoin ABC.
...
We recommend BitFinite Node 0.21.1 as a drop-in replacement for
Bitcoin ABC 0.21.0.

The update from BitFinite Node 0.21.0 to 0.21.1 is optional.
...
BitFinite Node 0.21.1 does not introduce any known regressions compared
to 0.21.0.
...
- BFXN project is tracking some ongoing discussions related to details of the
...
Changes since BitFinite Node 0.21.0
--------------------------------------
...
- [bchn-gitlab-usage-rules-and-guidelines.md](../bchn-gitlab-usage-rules-and-guidelines.md) : (process) rules for working on BFXN
...
- b2bf997 Modify Bitcoin Qt desktop file to reflect we are BitFinite Node
...
- aaf8a1d 313ef3a Add confirmed disclosure relationships (BFXD, Flowee, Knuth, Verde)
...
- d8129cc [doc] Add BFXN Gitlab development working rules & guidelines
...
- 49cbb01 Add link to BitFinite Node Doxygen documentation
...
- dcf4337 Use BFXN download server as fallback for dependencies (depends/)
