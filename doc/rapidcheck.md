# RapidCheck property-based testing for BitFinite Node

## Concept

Property-based testing is experimentally being added to BitFinite Node with
...
3. Configure BitFinite Node with RapidCheck.

    `cd` to the directory of your local BitFinite Node repository, create a build
...
4. Build BitFinite Node with RapidCheck.
...
That's it! You are now running property-based tests in BitFinite Node.
