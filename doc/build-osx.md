...
Build BitFinite Node
------------------------

Before you start building, please make sure that your compiler supports C++17.

Clone the BitFinite Node source code and cd into `bitcoin-cash-node`
...
Configure and build the headless BitFinite Node binaries, as well as the GUI.
...
After building the BitFinite Node binaries are available
