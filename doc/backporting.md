...
The official guide to backporting code between BitFinite Node and the Core or
...
BitFinite Node despite consensus-level differences between BitFinite and
Bitcoin Core.
...
in the BitFinite Node repository, fix bugs, and make future backports significantly
