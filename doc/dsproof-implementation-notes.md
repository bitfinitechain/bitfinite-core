Double Spend Proofs - BFXN Implementation Notes
===============================================

This document serves a two-fold purpose:

1. To give information to users of the BFXN software about expected behavior
...
DSProof implementation behavior in BFXN
---------------------------------------

We are providing here
some additional notes on the BFXN implementation of this feature.
...
1. A copy of the specification can be found at
   <https://upgradespecs.bitfinitenode.org/dsproof/>.
