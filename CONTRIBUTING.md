# Contributing to BitFinite Node

The BitFinite Node project welcomes contributors!
...
To get in contact with the BitFinite Node project, we monitor a number
of resources.
...
Our main chat is at <https://bitfinitenode.slack.com>, where we conduct
...
[https://bitfinitenode.org](https://bitfinitenode.org)

On all our channels, we seek to facilitate development of BitFinite Node,
and to welcome and support people who wish to participate.

Please visit our channels to

- Introduce yourself to other BitFinite Node contributors
...
## BitFinite Node Development Philosophy

BitFinite Node aims for fast iteration and continuous integration.
...
Here are some handy links for development practices aligned with BitFinite Node:

- [BFXN GitLab development working rules and guidelines](doc/bchn-gitlab-usage-rules-and-guidelines.md)
...
## Getting set up with the BitFinite Node Repository
...
5. Create a personal fork of the BitFinite Node repository for your work
...
9. Code formatting tools
    ...
    To enforce BitFinite Node codeformatting standards, you may need to
...
## Working with The BitFinite Node Repository
...
## BitFinite Node documentation

Find the complete project documentation at [https://docs.bitfinitenode.org/](https://docs.bitfinitenode.org/).
