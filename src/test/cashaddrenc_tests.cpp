...
BOOST_AUTO_TEST_CASE(encode_decode_all_sizes) {
    ...
    const std::string prefix = "bitfinite";
    ...
    for (auto ps : valid_sizes) {
        ...
        BOOST_CHECK_EQUAL_COLLECTIONS(std::begin(content.hash), std::end(content.hash), std::begin(decoded.hash),
                                      std::end(decoded.hash));
    }
}
...
BOOST_AUTO_TEST_CASE(test_encode_address) {
    ...
    std::vector<std::string> pubkey = {"bfx:fpm2fsznhks23z7629mms6s4cweq74vcwvzype89aj",
                                       "bfx:fr95sy3j9xwd2ap32xkykttr4cvcu7as4yqw8gq2mt",
                                       "bfx:fff3728yw0y47sfn6l2na30mcw6zm78dzf9hw70cdv"};
    std::vector<std::string> token_pubkey = {"bitfinite:zpm2fsznhks23z7629mms6s4cweq74vcwvpw5rnwfu",
                                             "bitfinite:zr95sy3j9xwd2ap32xkykttr4cvcu7as4y2yjjapx9",
                                             "bitfinite:zff3728yw0y47sfn6l2na30mcw6zm78dzfxamymnsz"};
    std::vector<std::string> script = {"bfx:ppm2fsznhks23z7629mms6s4cweq74vcwv4pukfxx0",
                                       "bfx:pr95sy3j9xwd2ap32xkykttr4cvcu7as4y7t68wqfk",
                                       "bfx:pff3728yw0y47sfn6l2na30mcw6zm78dzfjjn3gmk3"};
    std::vector<std::string> token_script = {"bitfinite:rpm2fsznhks23z7629mms6s4cweq74vcwvktqv5dmp",
                                             "bitfinite:rr95sy3j9xwd2ap32xkykttr4cvcu7as4yap0a6zac",
                                             "bitfinite:rff3728yw0y47sfn6l2na30mcw6zm78dzf3cxtustl"};
    ...
    for (size_t i = 0; i < hash.size(); ++i) {
        ...
        BOOST_CHECK_EQUAL(pubkey[i], EncodeCashAddr("bfx", keyContent));
        BOOST_CHECK(!keyContent.IsTokenAwareType());

        CashAddrContent tokenKeyContent{TOKEN_PUBKEY_TYPE, hash[i]};
        BOOST_CHECK_EQUAL(token_pubkey[i], EncodeCashAddr("bitfinite", tokenKeyContent));
        ...
        BOOST_CHECK_EQUAL(script[i], EncodeCashAddr("bfx", scriptContent));
        BOOST_CHECK(!scriptContent.IsTokenAwareType());

        CashAddrContent tokenScriptContent{TOKEN_SCRIPT_TYPE, hash[i]};
        BOOST_CHECK_EQUAL(token_script[i], EncodeCashAddr("bitfinite", tokenScriptContent));
...
BOOST_AUTO_TEST_CASE(test_vectors) {
    std::vector<CashAddrTestVector> cases = {
        // 20 bytes
        {"bitfinite", PUBKEY_TYPE, ParseHex("F5BF48B397DAE70BE82B3CCA4793F8EB2B6CDAC9"),
         "bitfinite:fr6m7j9njldwwzlg9v7v53unlr4jkmx6eyahvjqcdc"},
        {"bitfinite", TOKEN_PUBKEY_TYPE, ParseHex("F5BF48B397DAE70BE82B3CCA4793F8EB2B6CDAC9"),
         "bitfinite:zr6m7j9njldwwzlg9v7v53unlr4jkmx6ey6alv87jt"},
        ...
        {"prefix", CashAddrType(15), ParseHex("F5BF48B397DAE70BE82B3CCA4793F8EB2B6CDAC9"),
         "prefix:0r6m7j9njldwwzlg9v7v53unlr4jkmx6ey3fnjwsrq"},
        {"bchreg", PUBKEY_TYPE, ParseHex("d85c2b71d0060b09c9886aeb815e50991dda124d"),
         "bchreg:frv9c2m36frfkzwq3p4whf272zv3mksjq5ln6v9le5"},
        {"bchreg", TOKEN_PUBKEY_TYPE, ParseHex("d85c2b71d0060b09c9886aeb815e50991dda124d"),
         "bchreg:zrv9c2m36frfkzwq3p4whf272zv3mksjq5ceqjtex8"},
        {"bchreg", PUBKEY_TYPE, ParseHex("00aea9a2e5f0f876a588df5546e8742d1d87008f"),
         "bchreg:fff2a2dzuhc0sa493r0423hgwsk3mpcf3upac4z3wr"},
        {"bchreg", TOKEN_PUBKEY_TYPE, ParseHex("00aea9a2e5f0f876a588df5546e8742d1d87008f"),
         "bchreg:zff2a2dzuhc0sa493r0423hgwsk3mpcf3uxhttvh3s"},
        // 24 bytes
        {"bitfinite", PUBKEY_TYPE, ParseHex("7ADBF6C17084BC86C1706827B41A56F5CA32865925E946EA"),
         "bitfinite:f9adhakpwzztepkpwp5z0df62m6u5v5xtyj7j3h2v4uu7nac"},
        {"bitfinite", TOKEN_PUBKEY_TYPE, ParseHex("7ADBF6C17084BC86C1706827B41A56F5CA32865925E946EA"),
         "bitfinite:z9adhakpwzztepkpwp5z0df62m6u5v5xtyj7j3h27yjtc6ta"},
        {"bchtest", SCRIPT_TYPE, ParseHex("7ADBF6C17084BC86C1706827B41A56F5CA32865925E946EA"),
         "bchtest:p9adhakpwzztepkpwp5z0df62m6u5v5xtyj7j3h2u94tsynr"},
        {"bchtest", TOKEN_SCRIPT_TYPE, ParseHex("7ADBF6C17084BC86C1706827B41A56F5CA32865925E946EA"),
         "bchtest:r9adhakpwzztepkpwp5z0df62m6u5v5xtyj7j3h2w5mukd9x"},
        {"prefix", CashAddrType(15), ParseHex("7ADBF6C17084BC86C1706827B41A56F5CA32865925E946EA"),
         "prefix:09adhakpwzztepkpwp5z0df62m6u5v5xtyj7j3h2p29kc2lp"},
        // 28 bytes
        {"bitfinite", PUBKEY_TYPE, ParseHex("3A84F9CF51AAE98A3BB3A78BF16A6183790B18719126325BFC0C075B"),
         "bitfinite:fgagq7w02x4wnz3mkwnchut2vxphjzccwxgjvvjmlsxfwkcnkszra3n"},
        {"bitfinite", TOKEN_PUBKEY_TYPE, ParseHex("3A84F9CF51AAE98A3BB3A78BF16A6183790B18719126325BFC0C075B"),
         "bitfinite:zgagq7w02x4wnz3mkwnchut2vxphjzccwxgjvvjmlsxfwkc66s7qkza"},
        {"bchtest", SCRIPT_TYPE, ParseHex("3A84F9CF51AAE98A3BB3A78BF16A6183790B18719126325BFC0C075B"),
         "bchtest:pgagq7w02x4wnz3mkwnchut2vxphjzccwxgjvvjmlsxfwkcvs7md7wt"},
        {"bchtest", TOKEN_SCRIPT_TYPE, ParseHex("3A84F9CF51AAE98A3BB3A78BF16A6183790B18719126325BFC0C075B"),
         "bchtest:rgagq7w02x4wnz3mkwnchut2vxphjzccwxgjvvjmlsxfwkc9u7884a9"},
        {"prefix", CashAddrType(15), ParseHex("3A84F9CF51AAE98A3BB3A78BF16A6183790B18719126325BFC0C075B"),
         "prefix:0gagq7w02x4wnz3mkwnchut2vxphjzccwxgjvvjmlsxfwkc5djw8s9g"},
        // 32 bytes
        {"bitfinite", PUBKEY_TYPE,
         ParseHex("3173EF6623C6B48FFD1A3DCC0CC6489B0A07BB47A37F47CFEF4FE69DE825"
                  "C060"),
         "bitfinite:"
         "fvch8mmxy0rtqrlarg7ucrxxqzds5pamg73h7370aa87d80gyhfxfv8ehhhae"},
        {"bitfinite", TOKEN_PUBKEY_TYPE,
         ParseHex("3173EF6623C6B48FFD1A3DCC0CC6489B0A07BB47A37F47CFEF4FE69DE825"
                  "C060"),
         "bitfinite:"
         "zvch8mmxy0rtqrlarg7ucrxxqzds5pamg73h7370aa87d80gyhfxf759kwkyj"},
        {"bchtest", SCRIPT_TYPE,
         ParseHex("3173EF6623C6B48FFD1A3DCC0CC6489B0A07BB47A37F47CFEF4FE69DE825"
                  "C060"),
         "bchtest:"
         "pvch8mmxy0rtqrlarg7ucrxxqzds5pamg73h7370aa87d80gyhfxf7qfng6m6"},
        {"bchtest", TOKEN_SCRIPT_TYPE,
         ParseHex("3173EF6623C6B48FFD1A3DCC0CC6489B0A07BB47A37F47CFEF4FE69DE825"
                  "C060"),
         "bchtest:"
         "rvch8mmxy0rtqrlarg7ucrxxqzds5pamg73h7370aa87d80gyhfxfv6uj3mz3"},
        {"prefix", CashAddrType(15),
         ParseHex("3173EF6623C6B48FFD1A3DCC0CC6489B0A07BB47A37F47CFEF4FE69DE825"
                  "C060"),
         "prefix:"
         "0vch8mmxy0rtqrlarg7ucrxxqzds5pamg73h7370aa87d80gyhfxfsh6jgp6w"},
        // 40 bytes
        {"bitfinite", PUBKEY_TYPE,
         ParseHex("C07138323E00FA4FC122D3B85B9628EA810B3F381706385E289B0B256311"
                  "97D194B5C238BEB136FB"),
         "bitfinite:"
         "fnf8zwpj8cf05n7pytqmskuk9r4gzzel8ftsvwz79zdskqtrzxtar994cgutavqklv9fzsxx99"},
        {"bitfinite", TOKEN_PUBKEY_TYPE,
         ParseHex("C07138323E00FA4FC122D3B85B9628EA810B3F381706385E289B0B256311"
                  "97D194B5C238BEB136FB"),
         "bitfinite:"
         "znf8zwpj8cf05n7pytqmskuk9r4gzzel8ftsvwz79zdskqtrzxtar994cgutavqklvshwry30f"},
        {"bchtest", SCRIPT_TYPE,
         ParseHex("C07138323E00FA4FC122D3B85B9628EA810B3F381706385E289B0B256311"
                  "97D194B5C238BEB136FB"),
         "bchtest:"
         "pnf8zwpj8cf05n7pytqmskuk9r4gzzel8ftsvwz79zdskqtrzxtar994cgutavqklvmgm"
         "6ynej"},
        {"bchtest", TOKEN_SCRIPT_TYPE,
         ParseHex("C07138323E00FA4FC122D3B85B9628EA810B3F381706385E289B0B256311"
                  "97D194B5C238BEB136FB"),
         "bchtest:"
         "rnf8zwpj8cf05n7pytqmskuk9r4gzzel8ftsvwz79zdskqtrzxtar994cgutavqklvwlh"
         "qxynh"},
        {"prefix", CashAddrType(15),
         ParseHex("C07138323E00FA4FC122D3B85B9628EA810B3F381706385E289B0B256311"
                  "97D194B5C238BEB136FB"),
         "prefix:"
         "0nf8zwpj8cf05n7pytqmskuk9r4gzzel8ftsvwz79zdskqtrzxtar994cgutavqklvwsv"
         "ctzfy"},
        // 48 bytes
        {"bitfinite", PUBKEY_TYPE,
         ...
         "bitfinite:"
         "fh3krj5607v3flfh5c3wf3lrw3wnuxw0sp8dv0zugrrt5a3kj6ucysqz8kxwv2k53krr7"
         "n933jqsunfhadkszdc"},
        {"bitfinite", TOKEN_PUBKEY_TYPE,
         ParseHex("E361CA9A7F99107C17A622E047E3745D3E19CF804ED63C5C40C6BA763696"
                  "B98241223D8CE62AD48D863F4CB18C930E4C"),
         "bitfinite:"
         "zh3krj5607v3flfh5c3wf3lrw3wnuxw0sp8dv0zugrrt5a3kj6ucysqz8kxwv2k53krr7"
         "n933jqsunfmznxrx5q"},
        {"bchtest", SCRIPT_TYPE,
         ParseHex("E361CA9A7F99107C17A622E047E3745D3E19CF804ED63C5C40C6BA763696"
                  "B98241223D8CE62AD48D863F4CB18C930E4C"),
         "bchtest:"
         "ph3krj5607v3flfh5c3wf3lrw3wnuxw0sp8dv0zugrrt5a3kj6ucysqz8kxwv2k53krr7"
         "n933jqsunfnzq7mt6x"},
        {"bchtest", TOKEN_SCRIPT_TYPE,
         ParseHex("E361CA9A7F99107C17A622E047E3745D3E19CF804ED63C5C40C6BA763696"
                  "B98241223D8CE62AD48D863F4CB18C930E4C"),
         "bchtest:"
         "rh3krj5607v3flfh5c3wf3lrw3wnuxw0sp8dv0zugrrt5a3kj6ucysqz8kxwv2k53krr7"
         "n933jqsunflahwg0rh"},
        {"prefix", CashAddrType(15),
         ParseHex("E361CA9A7F99107C17A622E047E3745D3E19CF804ED63C5C40C6BA763696"
                  "B98241223D8CE62AD48D863F4CB18C930E4C"),
         "prefix:"
         "0h3krj5607v3flfh5c3wf3lrw3wnuxw0sp8dv0zugrrt5a3kj6ucysqz8kxwv2k53krr7"
         "n933jqsunfakcssnmn"},
        // 56 bytes
        {"bitfinite", PUBKEY_TYPE,
         ...
         "bitfinite:"
         "fmvl5lzvdm6km38lgga64ek5jhdl7e3afd9895wu04qvhlnare5937w4ywkf57juxsrhv"
         "w8ym5d8fx7sz7zz0zvcypfsqz8k084y"},
        {"bitfinite", TOKEN_PUBKEY_TYPE,
         ParseHex("D9FA7C4C6EF56DC4FF423BAAE6D495DBFF663D034A72D1DC7D52CBFE7D1E"
                  "6858F9D523AC0A7A5C34077638E4DD1A701BD017842789982041"),
         "bitfinite:"
         "zmvl5lzvdm6km38lgga64ek5jhdl7e3afd9895wu04qvhlnare5937w4ywkf57juxsrhv"
         "w8ym5d8fx7sz7zz0zvcypfsl08armgx"},
        {"bchtest", SCRIPT_TYPE,
         ParseHex("D9FA7C4C6EF56DC4FF423BAAE6D495DBFF663D034A72D1DC7D52CBFE7D1E"
                  "6858F9D523AC0A7A5C34077638E4DD1A701BD017842789982041"),
         "bchtest:"
         "pmvl5lzvdm6km38lgga64ek5jhdl7e3afd9895wu04qvhlnare5937w4ywkf57juxsrhv"
         "w8ym5d8fx7sz7zz0zvcypfs6kgdsg2g"},
        {"bchtest", TOKEN_SCRIPT_TYPE,
         ParseHex("D9FA7C4C6EF56DC4FF423BAAE6D495DBFF663D034A72D1DC7D52CBFE7D1E"
                  "6858F9D523AC0A7A5C34077638E4DD1A701BD017842789982041"),
         "bchtest:"
         "rmvl5lzvdm6km38lgga64ek5jhdl7e3afd9895wu04qvhlnare5937w4ywkf57juxsrhv"
         "w8ym5d8fx7sz7zz0zvcypfsvmgxu5h2"},
        {"prefix", CashAddrType(15),
         ParseHex("D9FA7C4C6EF56DC4FF423BAAE6D495DBFF663D034A72D1DC7D52CBFE7D1E"
                  "6858F9D523AC0A7A5C34077638E4DD1A701BD017842789982041"),
         "prefix:"
         "0mvl5lzvdm6km38lgga64ek5jhdl7e3afd9895wu04qvhlnare5937w4ywkf57juxsrhv"
         "w8ym5d8fx7sz7zz0zvcypfsgjrfpnw8"},
        // 64 bytes
        {"bitfinite", PUBKEY_TYPE,
         ParseHex("D0F346310D5513D9E01E299978624BA883E6BDA8F4C60883C10F28C2967E"
                  ...
                  "8884175B"),
         "bitfinite:"
         "flg0x333p4238k0frc5ej7rzqw5g8e4a4r6vvzyrcy8j3s5k0en7calvclhw46hudk5ql"
         "ttj6ydvjc0pv3nchp52amk97tfa5zygg96m5z9ppl8u"},
        {"bitfinite", TOKEN_PUBKEY_TYPE,
         ParseHex("D0F346310D5513D9E01E299978624BA883E6BDA8F4C60883C10F28C2967E"
                  "67EC77ECC7EEEAEAFC6DA89FAD72D11AC961E164678B868AEEEC5F2C1DA0"
                  "8884175B"),
         "bitfinite:"
         "zlg0x333p4238k0frc5ej7rzqw5g8e4a4r6vvzyrcy8j3s5k0en7calvclhw46hudk5ql"
         "ttj6ydvjc0pv3nchp52amk97tfa5zygg96m2kpcuun7"},
        {"bchtest", SCRIPT_TYPE,
         ParseHex("D0F346310D5513D9E01E299978624BA883E6BDA8F4C60883C10F28C2967E"
                  "67EC77ECC7EEEAEAFC6DA89FAD72D11AC961E164678B868AEEEC5F2C1DA0"
                  "8884175B"),
         "bchtest:"
         "plg0x333p4238k0frc5ej7rzqw5g8e4a4r6vvzyrcy8j3s5k0en7calvclhw46hudk5ql"
         "ttj6ydvjc0pv3nchp52amk97tfa5zygg96mc773cwez"},
        {"bchtest", TOKEN_SCRIPT_TYPE,
         ParseHex("D0F346310D5513D9E01E299978624BA883E6BDA8F4C60883C10F28C2967E"
                  "67EC77ECC7EEEAEAFC6DA89FAD72D11AC961E164678B868AEEEC5F2C1DA0"
                  "8884175B"),
         "bchtest:"
         "rlg0x333p4238k0frc5ej7rzqw5g8e4a4r6vvzyrcy8j3s5k0en7calvclhw46hudk5ql"
         "ttj6ydvjc0pv3nchp52amk97tfa5zygg96mx26g9ddf"},
        {"prefix", CashAddrType(15),
         ParseHex("D0F346310D5513D9E01E299978624BA883E6BDA8F4C60883C10F28C2967E"
                  "67EC77ECC7EEEAEAFC6DA89FAD72D11AC961E164678B868AEEEC5F2C1DA0"
                  "8884175B"),
         "prefix:"
         "0lg0x333p4238k0frc5ej7rzqw5g8e4a4r6vvzyrcy8j3s5k0en7calvclhw46hudk5ql"
         "ttj6ydvjc0pv3nchp52amk97tfa5zygg96ms92w6845"},
    };
...
BOOST_AUTO_TEST_CASE(token_json_test_vectors) {
    // Disabled for BitFinite: PUBKEY_TYPE changed to 9, invalidating standard test vectors.
    /*
