...
class AbandonConflictTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        # Verify that B and C's 10 BFX outputs are available for spending again
        ...
        # Invalidate the block with the double spend and B's 10 BFX output should no longer be available
