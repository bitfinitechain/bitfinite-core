...
"""Test validateblocktemplate RPC call. Adapted from BFXUnlimited
test for BFXN specific behavior (slightly different error strings
...
class ValidateblocktemplateTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        # Note: BFXN does not have RPC method like BU's 'setminingmaxblocksize' yet,
